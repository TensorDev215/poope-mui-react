...
const CloudImage = ({ styles }: CloudImageBoxProps) => {
    return <CloudImageBox src='assets/images/cloud.png' alt='Cloud' styles={styles} />
}
            ...
            <Container maxWidth='lg' sx={{ position: 'relative' }}>
                ...
                >
                    ...
                    <Typography variant='body1' sx={{ marginTop: '60px' }}>
                        Every bathromm break becomes a bullseye moment to embrace your inner marksman. Nail that tight
                        deadline, blast through the cryto world.
                    </Typography>
                </Box>
            </Container>
        </HeroBox>
